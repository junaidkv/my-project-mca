...
{
    public partial class VieweditPositon : Form
    {
        public VieweditPositon()
        {
            InitializeComponent();
        }
        ...
        private void VieweditPositon_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sendergrid.Columns[e.ColumnIndex] is DataGridViewButtonColumn && e.RowIndex >= 0)
            {
                ...
                string passpid = dataGridView1.Rows[rowindex].Cells[0].Value.ToString();
                if (passpid !="-1")
                {
                    editposition obj = new editposition(passpid);
                    obj.Show();
                    this.Hide();
                }
            }
